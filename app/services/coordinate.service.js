...
var CoordinateService = (function (_super) {
    __extends(CoordinateService, _super);
    ...
    CoordinateService.prototype.getSweepsForOperation = function (operationId) {
        ...
        return this.http.get(app_service_1.AppSettings.API_ENDPOINT + app_service_1.AppSettings.API_VERSION +
            'operations/' + operationId + '/sweeps', { headers: headers }).map(function (res) { return _this.extractData(res, sweep_1.Sweep.fromObject); })
